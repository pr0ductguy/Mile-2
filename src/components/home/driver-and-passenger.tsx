      ...
      <div className="wrapper">
        <div className="flex items-center mb-10 gap-5 md:gap-[77px] justify-between flex-col md:flex-row">
          <div className="md:w-[463px]" data-aos="fade-up" data-aos-delay="300">
            ...
            <p className="max-w-[487px] font-manrope text-sm lg:text-lg mt-6 lg:leading-[36px] mb-6 lg:mb-[59px]">
        ...
        <div className="flex items-center mb-10 gap-5 md:gap-[77px] justify-between flex-col md:flex-row">
          ...
          >
            ...
            <p className=" font-manrope text-sm lg:text-lg mt-6 lg:leading-[36px] mb-6 lg:mb-[59px]">
